...
function M.get(c, o)
  ...
  return {
    ...
    StatusLineSelect = { bg = c.yellow, fg = c.crust, bold = true },
    StatusLineInsert = { bg = c.green, fg = c.crust, bold = true },
    StatusLineVisual = { bg = c.peach, fg = c.crust, bold = true },
    StatusLineCommand = { bg = c.mauve, fg = c.crust, bold = true },
    StatusLineReplace = { bg = c.red, fg = c.crust, bold = true },
    StatusLineTerminal = { bg = c.sky, fg = c.crust, bold = true },
