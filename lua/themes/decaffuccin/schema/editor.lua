...
function M.get(c, o)
  return {
    ...
    CursorLine            = { bg = c.bg_cursorline },                                      -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if forecrust (ctermfg OR guifg) is not set.
    ...
    Pmenu                 = {
      bg = (o.transparency and vim.o.pumblend == 0) and c.none or c.bg_pmenu,
      fg = c.overlay2,
